...
# and linking them to our corpus by string matching; and 2) searching the Dataverse for titles of all papers 
...
get_dv_links <- function(file_in){
  ...
  # clean_url <- str_remove_all(clean_url, "\\.[^.]*$") # just for reference in case needed.
